...
.DESCRIPTION
    ...
    When $GitHubToken is set, the log is uploaded to odm-reports/logs/ as:
...
try {
    ...
    $localLogPath = Join-Path $localLogDir "PostCutoverHealth_${env:COMPUTERNAME}_${runTimestamp}.txt"
